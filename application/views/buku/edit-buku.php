			...
			$(document).ready(function () {
				...
				$.ajax({
					...
					success: function(data) {
						...
						$("[name='jenis_buku']").val(data.jenis_buku).change();
						$("[name='tanggal_input_buku']").val(data.tanggal_input_buku);
						$('#datepicker').datepicker('setDate', data.tanggal_input_buku);
						$("[name='sumber_buku']").val(data.sumber_buku);
						$("[name='buku_lama']").attr('checked', false);
						$("[name='buku_lama'][value='"+ +data.buku_lama +"']").attr('checked', true);
						$("[name='rak_buku']").val(data.rak_buku).change();
					}
				});
				//
				$("#form-input").validate({
					...
					submitHandler: function (form, event) {
						...
						//
						var data = $("#form-input").serialize() + '&id=' + uid;
						//
						$.ajax({
							type: "POST",
							dataType: "json", 
							data: data,
							url: "<?php echo base_url();?>buku/update_buku",
							success: function(data) {
